...
export function ProjectOverview({ project }: ProjectOverviewProps) {
  const upcomingDeadlines = [
    { task: "Complete foundation inspection", due: "2024-08-25", assignee: "John dela Cruz", priority: "high" },
  ...
  const recentUpdates = [
    { message: "Foundation concrete poured successfully", user: "John dela Cruz", time: "2 hours ago", type: "success" },
